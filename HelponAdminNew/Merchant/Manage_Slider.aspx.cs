...
namespace HelponAdminNew.Merchant
{
    public partial class Manage_Slider : System.Web.UI.Page
    {
        ...
        private void FillGv()
        {
            DataTable dtresult = cls.selectDataTable("ProcManage_Slider 'GetAll',0,'"+dtMerchant.Rows[0]["MID"]+"','Merchant'");
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            cls.ExecuteQuery("ProcManage_Slider 'insert','" + maxid + "','" + dtMerchant.Rows[0]["MID"] + "','Merchant','" + uploadStatus.ImgName + "'");
            ...
            if (file.HasFile)
            {
                if (file.PostedFile.FileName != "")
                {
                    ...
                    if (Extension == ".jpg" || Extension == ".jpeg" || Extension == ".png" || Extension == ".gif")
                    {
                        ...
                        objImgae.FixedSize(FileName, opath + FileName, Actual1 + FileName, 1350, 600);
