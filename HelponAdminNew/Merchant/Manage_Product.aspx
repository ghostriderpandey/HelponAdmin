<%@ Page Title="" Language="C#" MasterPageFile="~/Merchant/MerchantMaster.Master" AutoEventWireup="true" CodeBehind="Manage_Product.aspx.cs" Inherits="HelponAdminNew.Merchant.Manage_Product" %>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <asp:TextBox ID="txtQty" runat="server" CssClass="form-control" TextMode="Number" placeholder="Enter Quantity"></asp:TextBox>
                </div>
                 <div class="col-md-4">
                    <label>IGST</label>
