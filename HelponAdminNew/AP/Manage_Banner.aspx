<%@ Page Title="" Language="C#" MasterPageFile="~/AP/Admin.Master" AutoEventWireup="true" CodeBehind="Manage_Banner.aspx.cs" Inherits="HelponAdminNew.AP.Manage_Banner" %>
                ...
                <asp:GridView ID="gvData" runat="server" CssClass="table table-bordered table-condensed table-hover table-striped" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Slide IMG" HeaderStyle-Width="500px">
                            <ItemTemplate>
                                <img src='../Upload/Slide/Compress/<%# Eval("Img") %>' class='<%# Eval("Type").ToString()!="IMG"?"d-none":"" %>' style="" />
                                <video controls="controls" style="object-fit: cover; border-radius: 10px;" class='<%# Eval("Type").ToString()!="Video"?"d-none":"" %>'>
                                    <source src='../Upload/Slide/Actual/<%# Eval("Img") %>' type="video/mp4" />
                                </video>
                            </ItemTemplate>
                        </asp:TemplateField>
