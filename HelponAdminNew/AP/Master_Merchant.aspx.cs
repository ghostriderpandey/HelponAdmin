...
{
    public partial class Master_Merchant : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                   GetData(Convert.ToInt32(Request.QueryString["MID"]));
                }
            }
        }
        private void GetData(int mid)
        {
            ...
            if (merchant != null)
            {
                ...
                txtSponserID.Text = merchant.SponserID;
        ...
        {
            repo.BindDropDownList(ddlSubCategory, "GetSubCategory", Convert.ToInt32(ddlCategory.SelectedValue), "Name", "ID");
        }
